---
title: Tuna
description: Tuna is an open-source, self-hosted alternative to OpenAI's platform - build and run AI on your own desktop or server.
keywords:
  [
    Tuna,
    Tuna AI,
...
![Tuna's Cover Image](./_assets/jan-app.png)


Tuna is an AI chat application that runs 100% offline on your desktop & mobile (*coming soon*). Our goal is to
...
Tuna is powered by [Cortex](https://cortex.so/), our embeddable local AI engine which provides an OpenAI-compatible
...
and [Cline](https://cline.bot/), or any OpenAI-compatible app, to Tuna and start coding on their supported editors using
models hosted in Tuna.
