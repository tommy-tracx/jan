...
const ModalChangeDirectory: React.FC<Props> = ({
  ...
  return (
    <Modal
      open={show}
      title="Relocate Tuna Data Folder"
      onOpenChange={setShow}
      content={
        <div>
          <p className="text-[hsla(var(--text-secondary))]">
            Are you sure you want to relocate Tuna data folder to{' '}
            ...
            {isWindows && (
              <span>
                Note that Tuna will not erase the new Tuna data folder upon future
                uninstallation.
              </span>
            )}
          </p>
